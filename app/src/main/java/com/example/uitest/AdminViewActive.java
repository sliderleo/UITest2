...
public class AdminViewActive extends AppCompatActivity {
    ListView listView;
    ImageButton backbtn;
    Button suspendBtn;
    Info info,nameInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_active);
        database = FirebaseDatabase.getInstance();
        info=new Info();
        nameInfo=new Info();
        listView=findViewById(R.id.user_listview);
        backbtn=findViewById(R.id.img_back);
        suspendBtn=findViewById(R.id.suspend_button);
        ...
        suspendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AdminViewActive.this);
                builder.setTitle("Tow Car App");
                builder.setMessage("Are you sure you wan to suspend user "+name+" ?");
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        statusRef.child("status").setValue("0");
                        Toast.makeText(AdminViewActive.this,"User suspended!!",Toast.LENGTH_LONG).show();
                        finish();
